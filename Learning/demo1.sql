...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2023 at 07:57 AM
...
(1, 'manoj', 'manoj@gmail.com', 'manoj'),
(2, 'Lavanya', 'lavanya@gmail.com', 'lavanya@123');
...
--
ALTER TABLE `qp`
  ADD CONSTRAINT `qp_ibfk_1` FOREIGN KEY (`scode`) REFERENCES `subjects` (`scode`) ON UPDATE CASCADE;
